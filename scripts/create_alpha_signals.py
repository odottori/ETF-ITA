#!/usr/bin/env python3
"""
Alpha Signals - ETF Italia Project v10
Modulo strategie segnali secondo DIPF §4
"""
...
def create_alpha_signals_module():
    """Crea modulo strategies/alpha_signals.py"""
    
    strategies_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'strategies')
    os.makedirs(strategies_dir, exist_ok=True)
    
    alpha_signals_content = '''#!/usr/bin/env python3
"""
...
'''
    ...
    alpha_signals_path = os.path.join(strategies_dir, 'alpha_signals.py')
    with open(alpha_signals_path, 'w', encoding='utf-8') as f:
        f.write(alpha_signals_content)
    
    return alpha_signals_path

if __name__ == "__main__":
    create_alpha_signals_module()
    print("✅ Alpha signals module created")
